...
/*
 Abstract: background for ImportWalletViewController
 */
...
extension BackgroundView6 {
    override func draw(_ rect: CGRect) {
        ...
        initialPath.move(to: CGPoint(x: 0, y: y / 10 * 6))
        initialPath.addArc(tangent1End: CGPoint(x: x / 3, y: y / 10 * 3), tangent2End: CGPoint(x: x / 2, y: y / 10 * 6), radius: 50)
        initialPath.addArc(tangent1End: CGPoint(x: x / 2, y: y / 10 * 6), tangent2End: CGPoint(x: x / 3 * 2, y: y / 10 * 4), radius: 50)
        initialPath.addArc(tangent1End: CGPoint(x: x / 3 * 2, y: y / 10 * 4), tangent2End: CGPoint(x: x, y: y / 10 * 5), radius: 50)
        initialPath.addLine(to: CGPoint(x: x, y: y / 10 * 5))
        ...
        secondPath.move(to: CGPoint(x: 0, y: y / 10 * 8))
        secondPath.addArc(tangent1End: CGPoint(x: x / 5, y: y / 10 * 6), tangent2End: CGPoint(x: x / 2, y: y / 10 * 7), radius: 60)
        secondPath.addArc(tangent1End: CGPoint(x: x / 2, y: y / 10 * 7), tangent2End: CGPoint(x: x / 3 * 2, y: y / 10 * 6), radius: 40)
        secondPath.addArc(tangent1End: CGPoint(x: x / 3 * 2, y: y / 10 * 6), tangent2End: CGPoint(x: x, y: y / 10 * 7), radius: 40)
        secondPath.addLine(to: CGPoint(x: x, y: y / 10 * 7))
